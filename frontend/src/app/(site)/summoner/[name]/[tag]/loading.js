  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-2.5 border-b border-edge/30">
        <div className="h-4 w-40 bg-edge rounded animate-pulse" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="glass rounded-xl p-5">
              <div className="h-3 w-16 bg-edge rounded animate-pulse mb-3" />
              <div className="flex items-center gap-4">
                <div className="w-24 h-24 bg-edge rounded-xl animate-pulse" />
                <div className="flex-1 space-y-2">
                  <div className="h-6 w-32 bg-edge rounded animate-pulse" />
                  <div className="h-4 w-16 bg-edge rounded animate-pulse" />
                  <div className="h-4 w-24 bg-edge rounded animate-pulse" />
                </div>
              </div>
              <div className="mt-3 h-1.5 bg-edge rounded-full animate-pulse" />
            </div>

            {/* Flex card skeleton */}
            <div className="glass rounded-xl p-4">
              <div className="h-3 w-10 bg-edge rounded animate-pulse mb-3" />
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 bg-edge rounded-xl animate-pulse" />
                <div className="flex-1 space-y-2">
            ...
            <div className="glass rounded-xl p-5">
              ...
              <div className="grid grid-cols-5 gap-2">
                {Array.from({ length: 10 }).map((_, i) => (
                  <div key={i} className="w-full aspect-square bg-edge rounded-lg animate-pulse" />
                ))}
              </div>
            </div>
          </div>
              ...
              <div className="p-5 flex items-center justify-around">
                {Array.from({ length: 4 }).map((_, i) => (
                  <div key={i} className="flex flex-col items-center gap-2">
                    <div className="w-[110px] h-[110px] rounded-full bg-edge animate-pulse" />
              ...
              <div className="space-y-px">
                {Array.from({ length: 5 }).map((_, i) => (
                  <div key={i} className="px-4 py-3 flex items-center gap-3">
                    <div className="w-12 h-12 bg-edge rounded-xl animate-pulse" />
                    <div className="flex-1 space-y-2">
                      <div className="h-4 w-24 bg-edge rounded animate-pulse" />
                      <div className="h-3 w-36 bg-edge rounded animate-pulse" />
                    </div>
                    <div className="h-5 w-20 bg-edge rounded animate-pulse" />
                  </div>
                ))}
              </div>
            </div>
