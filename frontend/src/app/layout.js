    ...
    <html lang="tr" suppressHydrationWarning className={`${geist.variable} ${archivo.variable} ${manrope.variable} ${jetbrains.variable}`}>
      <head>
        ...
        {/* Rybbit analytics (self-host: a.elw.com.tr) — dev trafiği sayılmasın diye yalnız production.
            data-skip-patterns: admin paneli HİÇ sayılmasın. Kendi gezintimiz 30 günde 382
            gösterimin 31'iydi (~%8) — ziyaretçi istatistiğini o kadar şişiriyordu. Kendi
            analytics'imiz /admin'i zaten hariç tutuyordu, Rybbit tutmuyordu (2026-08-05). */}
        {process.env.NODE_ENV === "production" && (
          <script
            src="https://a.elw.com.tr/api/script.js"
            data-site-id="8a6203c50e34"
            data-skip-patterns='["/admin", "/admin/**"]'
            defer
          />
        )}
      </head>
