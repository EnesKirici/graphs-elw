...
const THEME_INIT = `(function(){try{var m=localStorage.getItem('elw-mode');if(m==='light')document.documentElement.classList.add('light');var a=localStorage.getItem('elw-accent');if(a)document.documentElement.style.setProperty('--accent',a);var b=localStorage.getItem('elw-bg-blur');if(b&&b!=='0')document.documentElement.style.setProperty('--bg-blur',b+'px');var g=localStorage.getItem('elw-glass-cards');if(g==='1')document.documentElement.classList.add('glass-cards');var v=localStorage.getItem('elw-bg-veil');if(v==='0')document.documentElement.classList.add('no-veil');var bg=localStorage.getItem('site-background');var be=localStorage.getItem('elw-bg-enabled');if(bg&&be!=='0')document.documentElement.classList.add('has-bg');}catch(e){}})();`;
