...
export const NAV_SECTIONS = [
  {
    ...
    items: [
      ...
      { href: "/admin/server", label: "Sunucu Durumu", icon: "M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2M5 12h14M8 8h.01M8 16h.01" },
    ],
  },
  {
    title: "Ayarlar",
    items: [
      ...
      { href: "/admin/settings/guides", label: "Şampiyon Rehberleri", icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" },
      ...
      { href: "/admin/settings/riot-key", label: "Riot API Anahtarı", icon: "M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" },
    ],
  },
];
