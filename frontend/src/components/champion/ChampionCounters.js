...
const STRIP = 5; // rakip şeridinde her yönde kaç kart
...
*/
function MatchupStrip({ good, bad, champName, pickedId, onPick }) {
  return (
    <div className="glass rounded-xl overflow-hidden">
      {/* Şeridin iki ucunu adlandıran başlıklar — okuma yönünü verir. */}
